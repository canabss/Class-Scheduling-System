		...
		<div class="row">
			...
			<div class="center">
	     		<div class="card" style="background:white; color:black;">
					...
					<div class="start">
						<a href="addSection.php" class="button" id="button" style="text-decoration:none; margin: 2px;">Add New Section</a>
					</div>
					<br><br>
					<script>
						...
						<div >
							<table id="Ptable"> 
								<thead> 
		     					...
		     					<tbody> 
		     					<?php
     $sql = "select * from section";			     							$result = mysqli_query($conn, $sql);
			     							$info = array();
