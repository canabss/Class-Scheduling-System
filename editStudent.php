					...
					<div class="bg-modal">
								<div class="main" style="left: 485px; top: 390px; position:-ms-page;" >
									<form action="editStudentProcess.php" method="POST">
										...
										<div class="data">
											<input type="hidden" placeholder="ID" name="id" id="id"  value="<?php echo $student['student_id'];?>">
										</div>
										<div class="data">
											<input type="text" placeholder="First Name" name="fname" id="fname" style="text-transform: capitalize;" value="<?php echo $student['fname'];?>">
										</div>

										<div class="data">
											<input type="text" placeholder="Middle Name" name="mname" id="mname" style="text-transform: capitalize;" value="<?php echo $student['mname'];?>">
										</div>

										<div class="data">
											<input type="text" placeholder="Last Name" name="lname" id="lname" style="text-transform: capitalize;" value="<?php echo $student['lname'];?>">
										</div>
										<div class="data">
											<input type="text" placeholder="Age" name="age" id="age" value="<?php echo $student['age'];?>">
										</div>
