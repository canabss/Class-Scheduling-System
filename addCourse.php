					...
					<div class="bg-modal">
								<div class="main" style="left: 485px; top: 390px; position:-ms-page;">
									<form action="addCourseProcess.php" method="POST">
										...
										<div class="data">
											<input type="text" placeholder="Course Title" name="title" id="title" style="text-transform: capitalize;">
										</div>

										<div class="data">
											<input type="text" placeholder="Course Acronym" name="acronym" id="acronym" style="text-transform: uppercase;">
										</div>
										<div class="data">
											<input type="text" placeholder="major" name="major" id="major" style="text-transform: capitalize;">
										</div>


										<div class="data">
											<input type="text" placeholder="Course Description" name="description" id="description" style="text-transform: capitalize;">
										</div>
