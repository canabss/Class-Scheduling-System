					...
					<div class="bg-modal">
								<div class="main" style="left: 485px; top: 390px; position:-ms-page;">
									<form action="editRoomProcess.php" method="POST">
										...
										<div class="data">
											<input type="text" placeholder="Room No." name="room_no" id="room_no" value="<?php echo $room['room_no'];?>">
										</div>

										<div class="data">
											<input type="text" placeholder="Building Name" name="building_name" id="building_name" style="text-transform: capitalize;" value="<?php echo $room['building_name'];?>">
										</div>
										<div class="data">
											<input type="text" placeholder="Description" name="description" id="description" style="text-transform: capitalize;" value="<?php echo $room['room_description'];?>">
										</div>
