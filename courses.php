...
?>
	<html lang="en">
		<head>
			<title>Class Scheduling System | Sections</title>
		...
		<div class="row">
			...
			<div class="center">
	     		<div class="card" style="background:white; color:black;">
					...
					<div class="start">
						<a href="addCourse.php" class="button" id="button" style="text-decoration:none;margin: 2px;">Add New Course</a>
					</div>
					<br><br>
					<script>
		     					...
		     					<?php
			     							...
			     							foreach($info as $data){
			     								echo "<tr>
			     										...
			     										<td>".$data["course_acronym"]."</td>
			     										<td>".$data["major"]."</td>
			     										<td>".$data["course_description"]."</td>
			     										
			     										<td><form method='post' action='editCourse.php' >
										                        <input name='id' type='hidden' value='".$data['course_id']."'>
										                        <input type='submit' class='button2' name='edit' value='Edit'>
									                        </form>
									                        <form  method='post' action='deleteCourseProcess.php'>
										                        <input name='id' type='hidden' value='".$data['course_id']."'>
